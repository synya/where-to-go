...
public class JsonUtilTest {
    ...
    public void testReadWriteValue() throws Exception {
        RestaurantTo toJson = groupByRestaurantWithVote(List.of(TODAY_MENU_ITEM2, TODAY_MENU_ITEM1), null).get(0);
    ...
    public void testReadWriteValues() throws Exception {
        List<RestaurantTo> toJsonList = groupByRestaurantWithVote(TODAY_MENU_ITEMS, null);
